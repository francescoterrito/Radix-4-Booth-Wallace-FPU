...
module fpnew_fma #(
  ...
  /* Add implicit bits to mantissae -> MANTISSA MULTIPLIER BITS WILL BE 8 BITS LONG INSTEAD OF 7 (IMPLICIT NORMALIZATION)
	The FP16ALT format intentionally does not store the leading 1 of the mantissa for normalized numbers, since is always 1 and can be added before multiplication */
  assign mantissa_a = {info_a.is_normal, operand_a.mantissa};
  assign mantissa_b = {info_b.is_normal, operand_b.mantissa};
  assign mantissa_c = {info_c.is_normal, operand_c.mantissa};
  
  // Mantissa multiplier (a*b) -> MODIFIED BOOTH ENCODING WALLACE TREE MULTIPLIER
  // assign product = mantissa_a * mantissa_b;

  // INSTANTIATE 8-BIT MODIFIED BOOTH ENCODING WALLACE TREE MANTISSA MULTIPLIER (1.xxxxxxx)
  wallace_tree #(
        .AW	(9),
        .BW	(9)
  ) wtree (
  ...
  //assign product = product16;   // connect to FMA pipeline
