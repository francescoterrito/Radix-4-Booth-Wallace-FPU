...
module fpnew_fma #(
  ...
  // EDITED FOR LAB2 EXERCISE 2.2
  // Mantissa multiplier (a*b) USING DW MULTIPLIER
  // assign product = mantissa_a * mantissa_b; (REMOVED FOR DW MULTIPLIER)
  DW02_mult_inst #(
	.A_width(PRECISION_BITS+1),
	.B_width(PRECISION_BITS+1)
  ) mant_mul (
	.inst_A(mantissa_a),
	.inst_B(mantissa_b),
	.inst_C(1'b0),
